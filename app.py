        ...
        <div class="svg-frame">
            ...
            <svg style="--i:1;--j:1;">
                <g id="out2">
                    ...
                    <path mask="url(#path-2-inside-2_111_3212)" fill="#00FFFF" d="M102.892 127.966L105.579 123.75L101.362 121.063L98.6752 125.28L102.892 127.966Z"></path>
                </g>
            </svg>
            <svg style="--i:0;--j:2;">
                <g id="inner3">
...
def _advance_to_next():
    # Vérifier si c'est le premier "Continuer" (première question validée)
    if "first_continue_done" not in st.session_state:
        st.session_state.first_continue_done = False
    
    if not st.session_state.first_continue_done:
        st.session_state.first_continue_done = True
